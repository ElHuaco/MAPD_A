...
HD_PWD='D:/Dokumente/mapd_a/UART/UART/UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_ALL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_ALL.tcl -notrace
