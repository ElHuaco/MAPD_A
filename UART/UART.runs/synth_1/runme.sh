...
HD_PWD='D:/Dokumente/mapd_a/UART/UART/UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_ALL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_ALL.tcl
